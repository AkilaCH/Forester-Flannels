(function ($) {
    ...
    // :: 4.0 Testimonials Slider Active Code
    if ($.fn.owlCarousel) {
        $(".Forester-testimonials-slides").owlCarousel({
            items: 1,
            margin: 0,
            loop: true,
            dots: true,
    ...
    // :: 6.0 Masonary Gallery Active Code
    if ($.fn.imagesLoaded) {
        $('.Forester-new-arrivals').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.Forester-new-arrivals').isotope({
    ...
    $('#sideMenuBtn').on('click', function () {
        $('#wrapper').toggleClass('Forester-side-menu-open');
    })
    $('#sideMenuClose').on('click', function () {
        $('#wrapper').removeClass('Forester-side-menu-open');
    })
